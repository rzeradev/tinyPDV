...
<header class="w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-full">
        ...
        <div class="flex flex-1 items-center space-x-2 justify-end">
              ...
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Content class="w-56">
                  ...
                  <DropdownMenu.Item>
                    <Button on:click={logout} variant="ghost"> <LogOut class="ml-2" /> Log out </Button>
                  </DropdownMenu.Item>
